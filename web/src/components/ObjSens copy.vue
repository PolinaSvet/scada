  ...
  <div class="obj-sensor" :style="sensorStyle" @click="handleClick">
    <svg :viewBox="viewBox" :width="props.w" :height="props.h" preserveAspectRatio="xMidYMid meet">
      <g id="mainGroup" transform="translate(0, 0)">
        ...
        <foreignObject x="5" y="0" width="90" height="15">
        ...
        <rect x="35" y="15" width="30" height="30" stroke-width="2" rx="3"
        ...
        <polyline points="15,5 10,15 20,15 15,25"
            fill="none" stroke="#000000" stroke-width="2" transform="translate(35,15)" />
      
        <text x="50" y="50" dominant-baseline="hanging" text-anchor="middle" fill="#000000" font-size="12" font-weight="normal">
          {{ computedState.inputValue }}
        </text>
        
        <g transform="translate(65,45)" :class="{ 'fade-transition': true }" 
